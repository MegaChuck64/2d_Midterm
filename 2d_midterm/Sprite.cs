...
namespace _2d_midterm
{
    ...
    class Sprite
    {
        ...
        //Constructor
        public Sprite(Vector2 worldLocation, Texture2D texture, Rectangle initialFrame, int numFrames,
            Vector2 velocity, float _scale)
        {
            ...
            {
                frames.Add(new Rectangle(initialFrame.Width * i, 0, initialFrame.Width, initialFrame.Height));
            }
        }
